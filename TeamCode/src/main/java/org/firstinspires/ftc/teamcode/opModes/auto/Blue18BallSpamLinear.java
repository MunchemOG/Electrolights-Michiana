...
public class Blue18BallSpamLinear extends NextFTCOpMode {
    ...
    // Transfer commands delegated to Transfer subsystem
    ...
    private SequentialGroup shoot = new SequentialGroup(
            openTransfer, new Delay(0.05), transferOn, new Delay(0.4), transferOff, closeTransfer
    );
    ...
    public class Paths {
        ...
        public Paths(Follower follower) {
            ...
            moverBacker = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(11.5, 66), new Pose(10, 60.25)))
            ...
            launchSet3 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(8, 42), new Pose(50.000, 94.000)))
                    .setLinearHeadingInterpolation(Math.toRadians(179), Math.toRadians(133))
                    .setVelocityConstraint(0.3).setTValueConstraint(0.95)
                    .addPoseCallback(new Pose(35, 69), reverseIntakeForMe, 0.8).build();

            teleOpPark = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(50.000, 94.000), new Pose(18, 72)))
                    .setLinearHeadingInterpolation(Math.toRadians(133), Math.toRadians(90)).build();
        }
    }
}
